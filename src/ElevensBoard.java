...
public class ElevensBoard extends Board {
	...
	public boolean isLegal(List<Integer> selectedCards) {
		...
		if (containsJQK(selectedCards) == true && selectedCards.size() == 3) {
			return true;
		} else if (containsPairSum11(selectedCards) == true && selectedCards.size() == 2) {
			return true;
		} else {
			return false;
		}
	...
	public boolean anotherPlayIsPossible() {
		...
		if (containsJQK(selectedCards) == true) {
			return true;
		} else if (containsPairSum11(selectedCards) == true) {
			return true;
		} else {
			return false;
		}	
	...
	private boolean containsPairSum11(List<Integer> selectedCards) {
		...
		for (int index : selectedCards) {
			for (int index2 : selectedCards) {
				if (cardAt(index).pointValue() + cardAt(index2).pointValue() == 11) {
					return true;
				}
			}
		}
